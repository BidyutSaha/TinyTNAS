...
constraints_specs= {"ram"   : 1024*100000000000,    # 'ram' in bytes
                    "flash" : 1024*106.76,    # 'flash' in bytes
                    "macc"  : 60*1000*1000000000 }
...
results = algo.search(epochs=epoch,  lossf = lossf , search_time_minute=60)
...
max_val_Acc = ModelTraning(best_model,train_ds,val_ds , epochs = 100, )
print(max_val_Acc)
